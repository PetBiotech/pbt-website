...
const checkValid=()=>{
    ...
    if (formElement.elements[8].checked==true){
        formElement.elements[8].classList.remove("is-invalid");
        formElement.elements[8].classList.add("is-valid");
    }else{
        formElement.elements[8].classList.remove("is-valid");
        formElement.elements[8].classList.add("is-invalid");
        flag = 1;
    }
    if(flag==0){
